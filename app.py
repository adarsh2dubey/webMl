...
#Using socket for detecting object in live video
@socketio.on('frame')
def handle_frame(data):
  
  # Taking image from client and covert it into opencvimage format
...
# This Function is used for supression in number of object detected in image 
# Occasionally, noise in the image is taken into account as
#  an object by the model, thus we must delete it after receiving the output.
...
#This function is used for loading label 
...
if __name__ == '__main__':
    #Loading tflite model at the time of server initiation
